...
class linkPizza_Manager {
	...
	private function load_dependencies() {
		...
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-linkPizza-Manager-option.php';
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/settings/class-linkPizza-Manager-callback-helper.php';
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/settings/class-linkPizza-Manager-meta-box.php';
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/settings/class-linkPizza-Manager-sanitization-helper.php';
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/settings/class-linkPizza-Manager-settings-definition.php';
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/settings/class-linkPizza-Manager-settings.php';
	...
	private function define_admin_hooks() {
		...
		$settings_callback = new linkPizza_Manager_Callback_Helper( $this->plugin_name );
		$settings_sanitization = new linkPizza_Manager_Sanitization_Helper( $this->plugin_name );
		$plugin_settings = new linkPizza_Manager_Settings( $this->get_plugin_name(), $settings_callback, $settings_sanitization);
		$this->loader->add_action( 'admin_init' , $plugin_settings, 'register_settings' );

		$plugin_meta_box = new linkPizza_Manager_Meta_Box( $this->get_plugin_name() );
