...
/**
 * linkPizza_Manager Callback Helper Class
 *
 ...
 */
class linkPizza_Manager_Callback_Helper {
	...
	public function checkbox_callback( $args ) {
		...
		$value = linkPizza_Manager_Option::get_option( $args['id'] );
	...
	public function multicheck_callback( $args ) {
		...
		$old_values = linkPizza_Manager_Option::get_option( $args['id'], array() );
	...
	public function radio_callback( $args ) {
		...
		$old_value = linkPizza_Manager_Option::get_option( $args['id'] );
	...
	private function input_type_callback( $type, $args ) {
		...
		$value = linkPizza_Manager_Option::get_option( $args['id'], $args['std']  );
