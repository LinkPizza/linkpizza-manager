...
/**
 * linkPizza_manager Sanitization Helper Class
 *
 ...
 */
class linkPizza_Manager_Sanitization_Helper {
	...
	public function __construct( $plugin_name ) {
		...
		$this->registered_settings = linkPizza_Manager_Settings_Definition::get_settings();
